...
|------|----|-------|--------|-------|
| Spec | [SPEC-006](../../../spec/Implemented/(SPEC-006)-Client-Node-Status-Web-UI/(SPEC-006)-Client-Node-Status-Web-UI.md) | Client Node Status Web UI | Draft | Python stdlib HTTP server on port 8888; generated by gen-peer-scripts |
