...
INSTALL_COMMANDS: dict[str, dict[OS, list[str]]] = {
    ...
    "terraform": {
        # HashiCorp's official Terraform binary is required (not OpenTofu) because
        # some providers (e.g. hetzner-community/hetznerdns) only exist in the
        # Terraform registry, not the OpenTofu registry.
        OS.LINUX: ["bash", "-c",
