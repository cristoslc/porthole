...
echo ""
echo "Next steps:"
echo "  1. For each peer, generate a tunnel SSH key (porthole gen-peer-scripts <name>)"
...
echo "     (porthole bootstrap or porthole sync handles this via nftables.conf.j2)"
